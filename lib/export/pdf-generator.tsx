...
function CoverPage({ report }: { report: Report }) {
  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.footer}>Generated by BadgerSignal</Text>
    </Page>
  )
}
  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.footer}>
        Page {pageNumber} of {totalPages} | Generated by BadgerSignal
      </Text>
    </Page>
  )
}
...
export function getPDFFileName(reportId: string): string {
  return `badgersignal-report-${reportId.slice(0, 8)}.pdf`
}
