...
>> = {
  en: {
    home: {
      ...
      title: 'Find and evaluate AI startup directions before you commit.',
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: 'Generate AI startup ideas with structure instead of random prompts.',
      description:
    ...
    'saas-idea-validation': {
      ...
      title: 'Validate a SaaS direction before you spend months building it.',
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Analyze which AI opportunity deserves your next move.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'AI tools for freelancers: see which workflow wedge looks strongest first.',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: 'Public sample report',
      title: 'AI tools for small business: find the workflow wedge owners pay for first.',
      description:
  ...
  de: {
    home: {
      ...
      title: 'Bewerte KI-Startup-Richtungen, bevor du dich festlegst.',
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: 'Mache aus einer Richtung klarere KI-Startup-Ideen statt zufalliger Prompts.',
      description:
    ...
    'saas-idea-validation': {
      ...
      title: 'Prufe eine SaaS-Richtung, bevor du Monate in den Bau investierst.',
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Analysiere, welche KI-Chance deinen nachsten Schritt verdient.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'KI-Tools fur Freelancer: welcher Workflow-Keil sieht zuerst am starksten aus?',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: 'Offentlicher Beispielbericht',
      title: 'KI-Tools fur kleine Unternehmen: finde den Workflow-Keil, fur den Inhaber zuerst zahlen.',
      description:
  ...
  fr: {
    home: {
      ...
      title: "Trouvez et evaluez des directions startup IA avant de vous engager.",
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: "Transformez une direction en idees startup IA plus nettes plutot qu'en prompts aleatoires.",
      description:
    ...
    'saas-idea-validation': {
      ...
      title: "Validez une direction SaaS avant d'y consacrer des mois de construction.",
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Identifiez quelle opportunite IA merite vraiment votre prochain mouvement.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'Outils IA pour freelances : quel angle de workflow semble le plus fort en premier ?',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: "Rapport d'exemple public",
      title: 'Outils IA pour petites entreprises : trouvez le workflow pour lequel les dirigeants paient en premier.',
      description:
  ...
  it: {
    home: {
      ...
      title: 'Trova e valuta direzioni startup AI prima di impegnarti davvero.',
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: 'Trasforma una direzione in idee startup AI piu solide, non in prompt casuali.',
      description:
    ...
    'saas-idea-validation': {
      ...
      title: 'Valida una direzione SaaS prima di investire mesi nello sviluppo.',
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Capisci quale opportunita AI merita davvero il tuo prossimo passo.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'Strumenti AI per freelance: quale wedge di workflow appare piu forte per primo?',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: 'Report pubblico di esempio',
      title: 'Strumenti AI per piccole imprese: trova il wedge di workflow per cui i titolari pagano per primo.',
      description:
  ...
  es: {
    home: {
      ...
      title: 'Encuentra y evalua direcciones de startup con IA antes de comprometerte.',
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: 'Convierte una direccion en ideas de startup con IA mas claras, no en prompts aleatorios.',
      description:
    ...
    'saas-idea-validation': {
      ...
      title: 'Valida una direccion SaaS antes de dedicar meses a construirla.',
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Analiza que oportunidad de IA merece tu siguiente movimiento.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'Herramientas IA para freelancers: que wedge de flujo parece mas fuerte primero?',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: 'Reporte publico de ejemplo',
      title: 'Herramientas IA para pequenas empresas: encuentra el flujo por el que los duenos pagan primero.',
      description:
  ...
  pt: {
    home: {
      ...
      title: 'Encontre e avalie direcoes de startup com IA antes de se comprometer.',
      description:
    ...
    'ai-startup-idea-generator': {
      ...
      title: 'Transforme uma direcao em ideias de startup com IA mais claras, nao em prompts aleatorios.',
      description:
    ...
    'saas-idea-validation': {
      ...
      title: 'Valide uma direcao SaaS antes de investir meses para construir.',
      description:
    ...
    'ai-business-opportunity-analysis': {
      ...
      title: 'Analise qual oportunidade de IA merece o seu proximo movimento.',
      description:
    ...
    'examples-ai-tools-for-freelancers': {
      ...
      title: 'Ferramentas de IA para freelancers: qual wedge de workflow parece mais forte primeiro?',
      description:
    ...
    'examples-ai-tools-for-small-business': {
      sectionLabel: 'Relatorio publico de exemplo',
      title: 'Ferramentas de IA para pequenas empresas: encontre o workflow pelo qual os donos pagam primeiro.',
      description:
...
>> = {
  en: {
    ...
    'saas-idea-validation': {
      ...
      heroVisualTitle: 'Test one SaaS idea hard enough to rule it in or out',
      heroVisualRows: [
  ...
  zh: {
    ...
    'saas-idea-validation': {
      ...
      heroVisualTitle: '聚焦一个 SaaS 点子，判断它该继续还是该停下',
      heroVisualRows: [
        { label: '验证深度', value: '聚焦' },
        { label: '取舍视图', value: '可见' },
