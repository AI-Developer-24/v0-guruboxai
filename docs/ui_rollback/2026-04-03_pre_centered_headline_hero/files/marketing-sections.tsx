    ...
    <MarketingSurface className="border-b border-border/45">
      ...
      <MarketingContainer className="py-7 sm:py-9 lg:py-12">
        <div className="relative overflow-hidden rounded-[2rem] border border-white/40 bg-[linear-gradient(145deg,oklch(1_0_0_/_0.64),oklch(0.985_0.005_250_/_0.42))] px-5 py-6 shadow-[0_24px_90px_oklch(0.58_0.08_250_/_0.06)] backdrop-blur-sm sm:px-7 sm:py-8 lg:px-8 lg:py-9">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.04fr)_minmax(300px,0.88fr)] lg:items-start lg:gap-10">
            <div className="max-w-[37rem] space-y-6">
              ...
              <div className="space-y-4">
                <h1
                  className={cn(
                    'text-balance font-medium leading-[0.82] tracking-[-0.09em] text-foreground',
                    'max-w-[12.2ch] text-[clamp(2.1rem,6vw,2.85rem)] sm:max-w-[12.4ch] sm:text-[clamp(2.75rem,4.6vw,3.75rem)] lg:max-w-[13ch] lg:text-[clamp(3.1rem,3.8vw,4.1rem)]',
                    titleClassName
                  )}
                >
                  {title}
  ...
  return (
    <div className="relative w-full max-w-[30rem]">
      ...
      <div className="relative space-y-5 pt-2">
        <div className="space-y-2 border-b border-border/35 pb-5">
          <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground">
            {eyebrow}
          </p>
          <p className="max-w-[14rem] text-[1.7rem] font-semibold leading-[1.02] tracking-[-0.05em] text-foreground sm:text-[1.95rem]">
            {title}
          </p>
        </div>
        ...
        <div className="absolute right-0 top-0 h-9 w-9 rounded-full border border-border/50 bg-white/65 shadow-sm" />
      </div>
    </div>
  )
}
...
export function MarketingDiagnosticVisual({
  ...
  return (
    <div className="relative w-full max-w-[30rem]">
      ...
      <div className="relative space-y-5 pt-2">
        <div className="flex items-start justify-between gap-4 border-b border-border/35 pb-5">
          <div className="max-w-[15rem] space-y-2">
            <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground">
              {eyebrow}
            </p>
            <p className="text-[1.7rem] font-semibold leading-[1.02] tracking-[-0.05em] text-foreground sm:text-[1.95rem]">
              {title}
            </p>
          </div>
          <ScanSearch className="size-8 shrink-0 text-[oklch(0.58_0.16_250)]" />
        </div>
        <div className="grid gap-3">
          {rows.map((row, index) => (
            <div key={row.label} className="space-y-2 border-b border-border/30 pb-3.5">
              <div className="flex items-center justify-between gap-4">
                ...
                <p className="text-lg font-semibold tracking-tight text-foreground">{row.value}</p>
              </div>
    ...
    <div className="relative w-full max-w-[30rem]">
      ...
      <div className="relative space-y-5 pt-2">
        <div className="flex items-start justify-between gap-4 border-b border-border/35 pb-5">
          ...
          <FileSearch className="size-8 shrink-0 text-[oklch(0.78_0.14_70)]" />
        </div>
        <div className="grid gap-3">
