...
const MARKETING_FOOTER_COPY: Record<SeoLocale, {
  tagline: string
  product: string
  examples: string
  company: string
...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 mt-auto border-t border-border/50 bg-[linear-gradient(180deg,oklch(1_0_0_/_0.54),oklch(0.985_0.005_250_/_0.48))] backdrop-blur-sm">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-12">
        <div className="grid gap-10 border-b border-border/40 pb-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          <div className="max-w-xl space-y-5">
            ...
            <Button asChild size="lg" className="btn-glow h-11 rounded-full px-6 text-sm">
              <Link href="/tools/product-insight">
                {marketingCopy.startAnalysis}
